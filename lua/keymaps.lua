...
maps.n["<C-Left>"] = { "<cmd>vertical resize -2<cr>", desc = "Shrink window vertically" }
maps.n["<C-Right>"] = { "<cmd>vertical resize +2<cr>", desc = "Increase window vertically" }
...
-- Clear highlights
maps.n["<leader>h"] = { "<cmd>noh<cr>", desc = "Clear highlights" }
...
maps.n["p"] = { "P==", desc = "Better paste" }

--Move Lines Better Way
maps.n["<A-j>"] = { ":m .+1<CR>==", desc = "Better move lines" }
maps.n["<A-k>"] = { ":m .-2<CR>==", desc = "Better move lines" }
maps.x["<A-j>"] = { ":move '>+1<CR>gv-gv", desc = "Better move lines" }
maps.x["<A-k>"] = { ":move '<-2<CR>gv-gv", desc = "Better move lines" }
maps.x["J"] = { ":move '>+1<CR>gv-gv", desc = "Better move lines" }
maps.x["K"] = { ":move '<-2<CR>gv-gv", desc = "Better move lines" }
-- maps.v["p"] = { '"_dP', desc = "Deleteing Black Hole Register wile Pasting" }
-- keymap("v", "p", '"_dP', opts)
...
--defined
maps.n["<leader>sp"] = { ":norm vip<CR>", desc = "Select Inside Paragraph"}
maps.n["<leader>si"] = { ":norm =i{<CR>", desc = "Indent Inside Paragraph"}
maps.n["<leader>sf"] = { ":norm V$%<CR>", desc = "Select Entire Function"}
maps.n["<A-q>"] = { ":q!<CR>", desc = "Quit Without Saving" }
maps.n["<A-w>"] = { ":w<CR>", desc = "Save File" }
